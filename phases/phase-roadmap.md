...
| **1** | API Contract & Mock Pipeline | All routes, auth, multipart validation, error envelope, storage/provider adapter seams, `FakeProvider`, and an end-to-end mock job through the real state machine. **Contract frozen.** | Sequential after 0b | Not started |
